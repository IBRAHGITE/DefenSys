...
<div class="panel-body" >
    <form method="POST" style="width: 90%; margin-left: 5%;" action="index.php?page=radio&var=store&elt=Radios">
        ...
        <div class="form-group row">
            <label class="col-form-label col-md-2 col-sm-2 col-xs-12">Compagnie <sup class="text-danger">*</sup></label>
            <div class="col-md-10 col-sm-10 col-xs-12">
                <select id="marque_vehicule" name="compagnie" class="js-example-responsive form-control" required>
                    <option value="">Choisir la compagnie ...</option>
                    <?php if (isset($liste_compagnies)) { ?>
                        <?php foreach ($liste_compagnies as $key => $site) { ?>
